--- 
title: "R Markdown 最佳指南"
author: ["Yihui Xie, J. J. Allaire, Garrett Grolemund（著）", "王诗翔（译）"]
date: "`r Sys.Date()`"
...
**提醒**: 这本书已经由 [Chapman & Hall/CRC](https://www.crcpress.com/p/book/9781138359338) 出版。这本书的线上版本在这里可以免费阅读（感谢 Chapman & Hall/CRC）（英文版本[点击此处](https://bookdown.org/yihui/rmarkdown/)阅读），以[知识共享署名-非商业性-相同方式共享4.0国际许可协议](http://creativecommons.org/licenses/by-nc-sa/4.0/)发行。
